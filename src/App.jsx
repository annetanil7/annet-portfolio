              ...
              <div className="max-w-4xl mx-auto">
                <div className="grid md:grid-cols-2 gap-x-12 gap-y-8">
                  {[
                    ...
                    <div key={idx} className="cert-animate group card-hover p-6 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-white/30 hover:bg-white/10 transition-all duration-300" style={{animationDelay: `${idx * 0.05}s`}}>
